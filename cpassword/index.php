...
<head>
	...
	<title>修改密码 | Change Password</title>
	<style>
		html {
			background: #EBEBEB;
			height: 100%;
...
<body>
	...
	<section>
		...
		<div class="form-box">
			...
			<form action="../data/cpassword.php" method="post">
				<div class="form-fields">
					<p>
						<input class="icoTip ico-account" type="text" name="user_name" placeholder="用户名 | 邮箱">
					</p>
					<p>
						<input class="icoTip ico-password" type="password" name="user_password" placeholder="密码">
					</p>
					<p>
						<input class="icoTip ico-password" type="password" name="user_confirm_password" placeholder="确认密码">
					</p>
				</div>
